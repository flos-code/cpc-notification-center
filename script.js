let notifications = [
    {
        user: 'Abdul',
        userImg: 'https://avataaars.io/?avatarStyle=Transparent&topType=ShortHairShortWaved&accessoriesType=Blank&hairColor=BrownDark&facialHairType=BeardLight&facialHairColor=BrownDark&clotheType=GraphicShirt&clotheColor=Blue02&graphicType=Deer&eyeType=Squint&eyebrowType=RaisedExcited&mouthType=Twinkle&skinColor=Brown',
        type: 'postLiked',
        color: '#e8e6e1'
    },
    {
        user: 'Hannes',
        userImg: 'https://avataaars.io/?avatarStyle=Transparent&topType=ShortHairShortRound&accessoriesType=Blank&hairColor=Black&facialHairType=Blank&clotheType=Hoodie&clotheColor=Gray01&eyeType=Happy&eyebrowType=Default&mouthType=Smile&skinColor=Tanned',
        type: 'invite',
        color: '#b6e0fe'
    },
    {
        user: 'Sophie',
        userImg: 'https://avataaars.io/?avatarStyle=Transparent&topType=LongHairNotTooLong&accessoriesType=Round&hairColor=Blonde&facialHairType=Blank&clotheType=ShirtVNeck&clotheColor=PastelGreen&eyeType=Surprised&eyebrowType=RaisedExcited&mouthType=Default&skinColor=Light',
        type: 'comment',
        color: '#f8cdcd'
    },
    {
        user: 'Mari',
        userImg: 'https://avataaars.io/?avatarStyle=Transparent&topType=LongHairBigHair&accessoriesType=Blank&hairColor=Auburn&facialHairType=Blank&clotheType=ShirtScoopNeck&clotheColor=Heather&eyeType=Squint&eyebrowType=DefaultNatural&mouthType=Twinkle&skinColor=Light',
        type: 'postLiked',
        color: '#fbefc7'
    },
    {
        user: 'Devin',
        userImg: 'https://avataaars.io/?avatarStyle=Transparent&topType=NoHair&accessoriesType=Sunglasses&facialHairType=Blank&clotheType=Hoodie&clotheColor=Black&eyeType=Close&eyebrowType=FlatNatural&mouthType=Smile&skinColor=DarkBrown',
        type: 'live',
        color: '#c6f7e2'
    }
...
function displayNotifications() {
    ...
    notifications.forEach((notification, index) => {
        allNotificationsElement.innerHTML += createNotificationHTML(notification, index);
    });
    allNotificationsElement.innerHTML += createDeleteAllHTML();
}

function createNotificationHTML(notification, index) {
    const messageType = getMessageBasedOnType(notification.type, notification.user);
    return `
...
function animateNotifications(show) {
    ...
    for (let index = 0; index < totalNotifications; index++) {
        const notificationElement = document.getElementById(`singleNotification${index}`);
        if (notificationElement) {
            const delay = show ? (index + 1) * 100 : (totalNotifications - index - 1) * 100;
            ...
            document.getElementById('deleteAll').style.animation = `${animationName} 0.5s ease forwards ${deleteDelay}ms`;
        }
    }
}
